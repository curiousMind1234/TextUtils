...
export default function Navbar(props) {
  ...
  return (
    <div className="App">
      <nav className={`navbar navbar-expand-lg navbar-${props.mode==='light' ? 'dark' :'white'} bg-${props.mode==='light' ? 'dark' :'white'}`}>
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className={`form-check form-switch text-${props.mode==="light" ? "white" : "dark"} mx-3`}>
            ...
            <div className={`form-check form-switch text-${props.mode==="light" ? "white" : "dark"} mx-3`}>
              <input className="form-check-input" type="checkbox" onClick={props.greenToggle} role="switch" id="flexSwitchCheckDefault" />
